...
const QAConsultingAudits = () => {
  ...
  const icons = [BadgeCheck, ListChecks, Layers, Puzzle];
      ...
      <section className="relative py-28 md:py-36 overflow-visible">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 mt-16">
            <p className="h1 font-bold text-slate-900 mb-4 gap-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="inline-flex items-center justify-center rounded-xl bg-teal-600 text-white px-6 py-3 text-sm md:text-base font-semibold shadow-sm hover:bg-teal-700 transition-colors"
              >
              ...
              <Link
                to="/services"
                className="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm md:text-base font-medium text-slate-800 hover:border-teal-500 hover:text-teal-700 transition-colors"
              >
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {consultingService.map((service, index) => (
              <ConsultingServiceCard key={index} {...service} />
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 bg-teal-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-center text-center gap-6 mb-10">
            <div>
              <p className="h2 text-white mb-3">
                How our QA consulting engagement works
              </p>
              <p className="body-regular text-gray-300 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {workflow.map((step, index) => (
              <div
                key={step.title}
                className="relative rounded-2xl bg-white border border-teal-600 p-5 flex flex-col h-full"
              >
                <div className="inline-flex items-center justify-between mb-3">
                  ...
                  {/* <span className="h-8 w-8 rounded-full bg-white flex items-center justify-center text-xs font-semibold text-black-900">
                    {index + 1}
                  </span> */}
                </div>
                <h3 className="text-base md:text-lg font-semibold text-teal mb-2">
                  {step.title}
                </h3>
                <p className="text-xs md:text-sm text-black-300 mb-2">
                  {step.description}
                </p>
                {/* <p className="text-xs text-slate-400 mt-auto">{step.detail}</p> */}
              </div>
            ))}
          </div>
          <div className="xs-regular flex justify-center items-center mt-12 text-gray-400 text-center">
            ...
            {differentiators.map((d, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Hover Accent Line */}
                  <span className="absolute bottom-0 left-0 h-1 w-0 bg-gradient-to-r from-teal-500 to-emerald-400 rounded-full transition-all duration-300 group-hover:w-full"></span>
                </div>
              );
            })}
          </div>
          ...
          <div className="relative overflow-hidden rounded-[28px]">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center px-6 sm:px-10 lg:px-14 py-12 lg:py-16">
              ...
              <div className="text-white">
                ...
                <p className="body-regular mt-6 text-white/90 max-w-2xl">
